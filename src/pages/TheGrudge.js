...
function TheGrudge(props){

    const origMovName = props.origMovName;
    const movName = "The Grudge";
    const movVal = "Release Date: 2004\n\nRating: 6.5/10\n\nThis felt like a lower-tier version of the Ring. There were some scary parts, but it can't compare to its 2002 predecessor.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjIxODg1Nzc3NF5BMl5BanBnXkFtZTcwMjM0MjEzMw@@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
