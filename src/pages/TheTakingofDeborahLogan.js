...
function TheTakingofDeborahLogan(props){

    const origMovName = props.origMovName;
    const movName = "The Taking of Deborah Logan";
    const movVal = "Release Date: 2014\n\nRating: 8/10\n\nThis movie was really good…I’ll have to rewatch again, but I don’t think it deserves to be in B tier.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNjhhNTM1OGUtYTRkZC00Mzg4LWFiY2ItYTUwMDg3NDIxYjExXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default TheTakingofDeborahLogan;