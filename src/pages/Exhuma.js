...
function Exhuma(props){

    const origMovName = props.origMovName;
    const movName = "Exhuma";
    const movVal = "Release Date: 2024\n\nRating: 7.5/10\n\nVery interesting South Korean horror flick. Love how they incorporate a lot of history from WW2 into it.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BOTA1OTY1NTYtNDEzZS00OTgyLWI1NWEtNDI5NjBhOTIwNzIyXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
