...
function TheRingTwo(props){

    const origMovName = props.origMovName;
    const movName = "The Ring Two";
    const movVal = "Release Date: 2005\n\nRating: 8/10\n\nSurprisingly good sequel, need to watch it again sometime. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTY2ODc2NTQ2OF5BMl5BanBnXkFtZTYwNzA4OTU3._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
