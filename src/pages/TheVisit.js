...
function TheVisit(props){

    const origMovName = props.origMovName;
    const movName = "The Visit";
    const movVal = "Release Date: 2015\n\nRating: 8/10\n\nOriginally I put this in B tier, but it deserves to be in A. The movie has an innovative concept and I think it is one of M. Night’s best films.";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTg3OTM2OTc5MV5BMl5BanBnXkFtZTgwMjMxNDM0NTE@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
