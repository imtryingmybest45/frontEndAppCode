...
function HouseofWax(props){

    const origMovName = props.origMovName;
    const movName = "House of Wax";
    const movVal = "Release Date: 2005\n\nRating: 8.5/10\n\nShould be in S tier because Paris Hilton is in it.";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNDA4Nzg1NjQ2NV5BMl5BanBnXkFtZTcwMDYwNTgyMQ@@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
