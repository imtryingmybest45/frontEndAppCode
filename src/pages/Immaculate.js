...
function Immaculate(props){

    const origMovName = props.origMovName;
    const movName = "Immaculate";
    const movVal = "Release Date: 2024\n\nRating: 7/10\n\nTruthfully, I've rewatched this movie a couple of times, and I quite liked it. Not an incredibly innovative movie (plot is basically a remake of Rosemary's Baby), but it's well done and fun to watch. Honestly, I should probably put it in B tier, it deserves it.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMWEzYjYyMjQtNTJjYi00ZDQ5LWE4N2MtNWY2ZTgxODNhYWM4XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
