...
function AsAboveSoBelow(props){
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTQzNzg0NDI2MF5BMl5BanBnXkFtZTgwMzgxNzY2MTE@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError = {handleError}/>}
