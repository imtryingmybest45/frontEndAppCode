...
function Midsommar(props){

    const origMovName = props.origMovName;
    const movName = "Midsommar";
    const movVal = "Release Date: 2019\n\nRating: 9/10\n\nHonestly one of my favorite Ari Aster movies. More disturbing than scary. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMzQxNzQzOTQwM15BMl5BanBnXkFtZTgwMDQ2NTcwODM@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
