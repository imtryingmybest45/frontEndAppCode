...
function HellHouseLLCIIILakeofFire(props){

    const origMovName = props.origMovName;
    const movName = "Hell House LLC III: Lake of Fire";
    const movVal = "Release Date: 2019\n\nRating: 6/10\n\nAnother mediocre sequel in the Hell House series. Truthfully, shame on this movie for almost making me skip the best movie in the whole series, The Carmichael Manor. The main character (I forget his name, it's been so long since I've seen this movie) is an asshole, and the special effects are terrible.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNDk1YmY1NDEtNTgxMy00MDJjLWIwMjctYmU4YTJmMDEyZGFjXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default HellHouseLLCIIILakeofFire;