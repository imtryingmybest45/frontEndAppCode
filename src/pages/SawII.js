...
function SawII(props){

    const origMovName = props.origMovName;
    const movName = "Saw II";
    const movVal = "Release Date: 2005\n\nRating: 8/10\n\nHappy they decided to continue the franchise. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BZGVlNjk3MmItZmUzNy00MzcyLWIzOTktZjllYWU5MDAyMjM1XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
