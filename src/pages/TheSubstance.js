...
function TheSubstance(props){

    const origMovName = props.origMovName;
    const movName = "The Substance";
    const movVal = "Release Date: 2024\n\nRating: 9/10\n\nReally gut-wrenching movie, especially as a woman. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BZDQ1NGE5MGMtYzdlZC00ODExLWJlMDMtNWU4NjA5OWYwMDEwXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
