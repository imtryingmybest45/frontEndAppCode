...
function BlairWitch(props){

    const origMovName = props.origMovName;
    const movName = "Blair Witch";
    const movVal = "Release Date: 2016\n\nRating: 7.5/10\n\nAnother rare situation where the remake far exceeds the original.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjI0NTEyMjA3NV5BMl5BanBnXkFtZTgwODk5OTU4OTE@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
