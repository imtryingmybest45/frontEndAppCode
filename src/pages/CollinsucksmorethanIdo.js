...
function CollinsucksmorethanIdo(props){

    const origMovName = props.origMovName;
    const movName = "Collin sucks more than I do
";
    const movVal = "I will admit that I suck, but you know who sucks more? Collin. In fact he sucks more than any other person on the planet. Also he is poor, and all poor people deserve to die.";
    const movTier = "S";
...
export default CollinsucksmorethanIdo;