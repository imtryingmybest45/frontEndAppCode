...
function Smile2(props){
    ...
    const movName = "Smile 2";
    const movVal = "Release Date: 2024\n\nRating: 8/10\n\nAnother movie that I’m considering putting in A tier. I’ll have to watch it again.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BYTg5OTMyMGMtYzMwNC00NDMyLWE0OGUtMTQ1ODcwM2FjOTM4XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
