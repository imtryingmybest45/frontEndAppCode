...
function HellHouseLLC(props){

    const origMovName = props.origMovName;
    const movName = "Hell House LLC";
    const movVal = "Release Date: 2015\n\nRating: 7/10\n\nA classic found footage horror, but I thought its 3rd sequel was way better. Unfortunately, you have to watch all three previous Hell Houses to understand the Carmichael manor one, but it’s totally worth it.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNDU2YTZhZTEtNjQ2Mi00ZTlkLWFhNTctNDAyNGNjNTVlYzdkXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
