...
function DreamEater(props){

    const origMovName = props.origMovName;
    const movName = "Dream Eater";
    const movVal = "Release Date: 2025\n\nRating: 8.5/10\n\nTruthfully was wavering on whether or not to put this in S tier. One of the best horror movies I've seen in a long time. What else should I expect...Eli Roth made it.";
    const movTier = "A";
    const movYear = "2025";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNzhlYzNiYWEtYjhjNi00MzM5LWE5ZjctNDMwYmYxM2Q5ZTA3XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
