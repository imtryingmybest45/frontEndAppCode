...
function Sinister2(props){

    const origMovName = props.origMovName;
    const movName = "Sinister 2";
    const movVal = "Release Date: 2015\n\nRating: 9/10\n\nAmazingly good sequel. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjM3MTQ5NjA0OV5BMl5BanBnXkFtZTgwMzg2OTYyNTE@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
