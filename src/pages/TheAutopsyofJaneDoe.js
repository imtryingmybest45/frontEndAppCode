...
function TheAutopsyofJaneDoe(props){
    ...
    const movVal = "Release Date: 2016\n\nRating: 10/10\n\nOne of the scariest horror movies of all time. Rest of review coming soon!";
    const movTier = "S";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjA2MTEzMzkzM15BMl5BanBnXkFtZTgwMjM2MTM5MDI@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
