...
function HellHouseLLCIITheAbaddonHotel(props){

    const origMovName = props.origMovName;
    const movName = "Hell House LLC II: The Abaddon Hotel";
    const movVal = "Release Date: 2018\n\nRating: 6.5/10\n\nA fine sequel, nothing particularly special and pales in comparison to the original. Fun fact: Abaddon is actually an infamous demon in Christian lore.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BYTdjNzU4ZDAtZDIyNi00OGM2LTgzMGItZDQzYmY4ZThjZTBiXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default HellHouseLLCIITheAbaddonHotel;