...
function Grease(props){

    const origMovName = props.origMovName;
    const movName = "Grease";
    const movVal = "This is the movie review for Grease";
    const movTier = "NO";
    const movYear = "1978";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNGY0NzE0ZTctN2YzNC00M2IwLWI0OWYtMTAwZWU2NjZhMTQwXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
