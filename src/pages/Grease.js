...
function Grease(props){
    ...
    const movVal = "This is a movie review for the movie Grease.";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNGY0NzE0ZTctN2YzNC00M2IwLWI0OWYtMTAwZWU2NjZhMTQwXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
