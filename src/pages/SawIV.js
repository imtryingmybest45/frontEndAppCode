...
function SawIV(props){

    const origMovName = props.origMovName;
    const movName = "Saw IV";
    const movVal = "Release Date: 2007\n\nRating: 6/10\n\nTruthfully, they should have stopped at Saw III. They just further complicated an already complicated story with this movie, and I think they lost the plot.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNjc0NjUyNzg3MF5BMl5BanBnXkFtZTYwODMxOTM3._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
