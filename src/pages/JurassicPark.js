...
function JurassicPark(props){

    const origMovName = props.origMovName;
    const movName = "Jurassic Park";
    const movVal = "This is the review for Jurassic Park!\n\nIt came out in 1993.\n\nI liked Jurassic World more.";
    const movTier = "S";
    const movYear = "1993";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjM2MDgxMDg0Nl5BMl5BanBnXkFtZTgwNTM2OTM5NDE@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
