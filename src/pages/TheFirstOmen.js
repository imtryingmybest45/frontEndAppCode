...
function TheFirstOmen(props){

    const origMovName = props.origMovName;
    const movName = "The First Omen";
    const movVal = "Release Date: 2024\n\nRating: 8/10\n\nThis movie does not deserve to be in B tier. I’ve rewatched it enough times that it should be in A.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNWU0ZjM1YjYtMGZkZi00NTBiLTgxMGItMzVhZDgyZTkyY2ZhXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
