...
function AllHallowsEve(props){

    const origMovName = props.origMovName;
    const movName = "All Hallows' Eve";
    const movVal = "Release Date: 2013\n\nRating: 9/10\n\nDamien Leon's debut as a director, and it holds a special place in my heart.";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNDc5ZTk4ZjUtNWRkNS00ZDg2LThkY2YtNjIyNGMwZWI4MmRiXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
