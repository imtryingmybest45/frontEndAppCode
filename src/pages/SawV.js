...
function SawV(props){
    ...
    const movName = "Saw V";
    const movVal = "I haven't seen this movie, but I already know it's bad.";
    const movTier = "F";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNWViYzg3YzItYzQxNS00MTE1LWJkNTMtMTM3OGI4ODAxOTMwXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
