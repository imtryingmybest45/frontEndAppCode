...
function TheRing(props){

    const origMovName = props.origMovName;
    const movName = "The Ring";
    const movVal = "Release Date: 2002\n\nRating: 9.5/10\n\nTruly terrifying movie with lots of complex lore. Rest of review coming soon!";
    const movTier = "S";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNDA2NTg2NjE4Ml5BMl5BanBnXkFtZTYwMjYxMDg5._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
