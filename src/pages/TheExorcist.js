...
function TheExorcist(props){

    const origMovName = props.origMovName;
    const movName = "The Exorcist";
    const movVal = "Release Date: 1973\n\nRating: 6/10\n\nAnother classic with poor special effects that, in my opinion, doesn't deserve all the hype. I suppose the Exorcist walked to all the Exorcist remakes could run, so it should get some credit, but just because a movie is innovative doesn't mean it's good.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BZjg3YjE4ZjAtYTdmYS00ZTBkLWE1ZjgtNzAzODUwNzRiYjlmXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
