...
function TheEmptyMan(props){

    const origMovName = props.origMovName;
    const movName = "The Empty Man";
    const movVal = "Release Date: 2020\n\nRating: 6.5/10\n\nAnother movie with a promising exposition but a confusing ending. Shame...it had the potential to be good.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMzI3OWYwNTQtOWM1Yi00Zjc1LWJmOGItN2UzMTNmNmJmZjE3XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
