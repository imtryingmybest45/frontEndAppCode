...
function Caveat(props){
    ...
    const movName = "Caveat";
    const movVal = "Release Date: 2020\n\nRating: 7.5/10\n\nFucking love this indie horror film, such a cool concept. Also, fuck that rabbit.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNDRjNzA2YjktNTk1OC00NTM1LTg1ZDgtYjRhM2Y4MGI5ODhkXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
