...
function TheConjuringTheDevilMadeMeDoIt(props){

    const origMovName = props.origMovName;
    const movName = "The Conjuring: The Devil Made Me Do It";
    const movVal = "This was a garbage movie, sadly.";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNThkYWE3OGItNzAyNC00N2U4LThjY2QtMGQwYjZhYTI1MzMwXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default TheConjuringTheDevilMadeMeDoIt;