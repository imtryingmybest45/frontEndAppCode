...
function ThisMovieDoesntExist(props){

    const origMovName = props.origMovName;
    const movName = "This Movie Doesnt Exist";
    const movVal = "this is am movie that does not exist.";
...
export default ThisMovieDoesntExist;