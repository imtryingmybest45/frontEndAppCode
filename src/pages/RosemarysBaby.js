...
function RosemarysBaby(props){

    const origMovName = props.origMovName;
    const movName = "Rosemary’s Baby";
    const movVal = "Release Date: 1968\n\nRating: 7.5/10\n\nOriginally, I thought it was a better version of Immaculate, but now I think I like them both equally, but for different reasons. I enjoy the pacing, lighting, and setting of Immaculate more, but I think Rosemary’s Baby more effectively escalates tension while weaving in historical lore. Out of the two, Immaculate is more rewatchable, but Rosemary’s Baby is more well thought-out.";
    const movTier = "B";
