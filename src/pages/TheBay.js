...
function TheBay(props){

    const origMovName = props.origMovName;
    const movName = "The Bay";
    const movVal = "Release Date: 2012\n\nRating: 5/10\n\nAnother utterly unmemorable found footage movie.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNDEzMWU2YWUtOWVkMy00OTg0LTkyMjctMDA3MDc2NGViYjU5XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
