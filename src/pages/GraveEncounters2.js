...
function GraveEncounters2(props){
    ...
    const movVal = "Release Date: 2012\n\nRating: 100/10\n\n100/10 just because our king, our legend, Lance Preston, returned.";
    const movTier = "C";
    const movYear = "2012";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTM2NTIzMDQ0NV5BMl5BanBnXkFtZTcwOTQ3NTM0OA@@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
