...
function TheExorcismofEmilyRose(props){

    const origMovName = props.origMovName;
    const movName = "The Exorcism of Emily Rose";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTI2NTM5MjQ0Nl5BMl5BanBnXkFtZTcwNDAxNjAzMQ@@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
...
export default TheExorcismofEmilyRose;