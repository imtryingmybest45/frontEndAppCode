...
function DeletePage(){
    ...
    const yesClick = (movie) => {
        ...
        axios.post('https://helpme-e5h7aua4bpcqchae.canadacentral-01.azurewebsites.net/deleteEndpoint',movie)
    ...
    useEffect(() => {
      if (typeof location.initVar === 'undefined'){
        ...
        axios.get('https://helpme-e5h7aua4bpcqchae.canadacentral-01.azurewebsites.net/submitEndpoint')
