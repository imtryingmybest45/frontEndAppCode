...
function Haunt(props){

    const origMovName = props.origMovName;
    const movName = "Haunt";
    const movVal = "Release Date: 2019\n\nRating: 8.5/10\n\nI need to move this to A tier.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BZDM4ZTIyMTAtNDg3ZS00NDIzLThjZDYtMjRmYjE5OWI3ZTViXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
