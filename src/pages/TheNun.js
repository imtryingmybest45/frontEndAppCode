...
function TheNun(props){

    const origMovName = props.origMovName;
    const movName = "The Nun";
    const movVal = "Release Date: 2018\n\nRating: 4/10\n\nThis movie was such a disappointment. It would have been better off not being made.";
    const movTier = "D";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjM3NzQ5NDcxOF5BMl5BanBnXkFtZTgwNzM4MTQ5NTM@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
