...
function Psycho(props){

    const origMovName = props.origMovName;
    const movName = "Psycho";
    const movVal = "Release Date: 1960\n\nRating: 7.5/10\n\nPossibly the oldest horror movie I’ve ever seen, I was pleasantly surprised by the quality of it.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BYjZhMzFiZjItODA3ZC00MmRhLWIzMGYtMmVjOWUwYTA3MTRjXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
