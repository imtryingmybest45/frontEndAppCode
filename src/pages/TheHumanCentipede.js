...
function TheHumanCentipede(props){

    const origMovName = props.origMovName;
    const movName = "The Human Centipede";
    const movVal = "Release Date: 2010\n\nRating: 9/10\n\nThis was a fun, lighthearted movie. It’s great for a fun watch with the kids on a Sunday afternoon.";
...
export default TheHumanCentipede;