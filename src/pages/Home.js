import BringHerBack2 from './BringHerBack2';
...
function Home(props){
  ...
  const linksData = useMemo(() => {
    ...
    const linksDataUnsorted = [
      ...
      { id: 7, text: 'Bring Her Back 2', to: '/BringHerBack2', name: "Bring Her Back 2" },
    ];
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/BringHerBack2" element={<BringHerBack2 name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
      </Routes>
      <nav>
