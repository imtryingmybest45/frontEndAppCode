...
function Home(props){
  ...
  const linksData = useMemo(() => {
    ...
    const linksDataUnsorted = [
      ...
      { id: 44, text: "Sátántangó", to: "/Stntang", name: "Sátántangó", moviePoster: 'error', tier: 'S'},
    ];
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/Stntang" element={<Stntang name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
      </Routes>
      <nav>
