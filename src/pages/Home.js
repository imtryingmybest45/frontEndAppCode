...
function Home(props){
  ...
  const linksData = useMemo(() => {
    ...
    const linksDataUnsorted = [
      ...
      { id: 14, text: "Sinister", to: "/Sinister", name: "Sinister", moviePoster: 'https://m.media-amazon.com/images/M/MV5BMjMzMTg5MTUzMF5BMl5BanBnXkFtZTgwMDk1NTA2MDE@._V1_SX300.jpg', tier: 'S', longReview: 'N',},
    ];
