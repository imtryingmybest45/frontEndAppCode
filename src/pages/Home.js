...
import ChildsPlay2018 from './ChildsPlay2018';
...
function Home(props){
  ...
  const linksData = useMemo(() => {
    ...
    const linksDataUnsorted = [
      ...
      { id: 96, text: "Child's Play (2018)", to: "/ChildsPlay2018", name: "Child's Play (2018)", moviePoster: 'https://m.media-amazon.com/images/M/MV5BMjM2YjJkYmYtOWZhNi00YmJhLWI2MTEtOTU2OWY4NGM2MTUwXkEyXkFqcGdeQXVyODgwNjcyMDU@._V1_SX300.jpg', tier: 'B', longReview: 'N',},
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/ChildsPlay2018" element={<ChildsPlay2018 name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
