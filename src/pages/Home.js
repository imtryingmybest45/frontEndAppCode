import TheDescentthe3 from './TheDescentthe3';
import TheDescentthe2 from './TheDescentthe2';
...
function Home(props){
  ...
  const linksData = useMemo(() => {
    return [
      ...
      { id: 3, text: 'Insidious 2', to: '/Insidious2' },
      { id: 5, text: 'The Descent the 2', to: '/TheDescentthe2' },
      { id: 6, text: 'The Descent the 3', to: '/TheDescentthe3' },
    ];
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/TheDescentthe2" element={<TheDescentthe2 name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
        <Route path="/TheDescentthe3" element={<TheDescentthe3 name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
      </Routes>
      <nav>
