...
function Home(props){
  ...
  const linksData = useMemo(() => {
    return [
      ...
      { id: 4, text: 'Hello Mom', to: '/HelloMom' },
    ];
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/HelloMom" element={<HelloMom name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
      </Routes>
      <nav>
