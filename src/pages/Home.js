import Aprilisashortloser from './Aprilisashortloser';
...
function Home(props){
  ...
  const linksData = useMemo(() => {
    ...
    const linksDataUnsorted = [
      ...
      { id: 37, text: "April is a short loser", to: "/Aprilisashortloser", name: "April is a short loser", moviePoster: 'error', tier: 'Cuper short'},
    ];
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/Aprilisashortloser" element={<Aprilisashortloser name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
      </Routes>
      <nav>
