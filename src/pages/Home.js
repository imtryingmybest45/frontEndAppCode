import AprilsHorrorCornerdotcom from './AprilsHorrorCornerdotcom';
...
function Home(props){
  ...
  const linksData = useMemo(() => {
    return [
      ...
      { id: 6, text: 'Aprils Horror Corner dot com', to: '/AprilsHorrorCornerdotcom' },
    ];
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/AprilsHorrorCornerdotcom" element={<AprilsHorrorCornerdotcom name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
      </Routes>
      <nav>
