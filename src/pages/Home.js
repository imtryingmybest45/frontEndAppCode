...
function Home(props){
  ...
  const linksData = useMemo(() => {
    ...
    const linksDataUnsorted = [
      ...
      { id: 12, text: "Captain America", to: "/CaptainAmerica", name: "Captain America" },
    ];
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/CaptainAmerica" element={<CaptainAmerica name = {props.prevPath} age={props.setPrevPath} reinit={props.reinit} origMovName={origMovName}/>} />
      </Routes>
      <nav>
