...
function TheGirlNextDoor(props){

    const origMovName = props.origMovName;
    const movName = "The Girl Next Door";
    const movVal = "Release Date: 2007\n\nRating: Do not watch/10\n\nThis movie wasn't even jokingly bad. It was truly disturbing, and my soul felt heavier after watching it. Would not recommend.";
    const movTier = "NO";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTQ0ODIyMzE1N15BMl5BanBnXkFtZTcwODEwODczMw@@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default TheGirlNextDoor;