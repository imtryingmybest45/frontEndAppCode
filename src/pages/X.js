...
function X(props){
    ...
    const movName = "X";
    const movVal = "Release Date: 2022\n\nRating: 6.5/10\n\nMainly appreciated it for the porn scenes. Plot was mid. Basically porn with a plot, with emphasis on the porn.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BODUwYTNhMTMtYWQ5Ny00YTdmLWIxOTAtNDczNzVlYzg2NDFkXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
