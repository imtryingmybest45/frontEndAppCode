...
function Poltergeist2015(props){

    const origMovName = props.origMovName;
    const movName = "Poltergeist (2015)";
    const movVal = "Release Date: 2015\n\nRating: 5.5/10\n\nTruthfully, I didn’t like the original Poltergeist or the remake. Sue me.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BYzY1ZWIwZDAtYzhjNi00NWFmLTgzM2QtMjk5ZDVjOWNkMTljXkEyXkFqcGdeQXVyNDQyOTMwNzI@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default Poltergeist2015;