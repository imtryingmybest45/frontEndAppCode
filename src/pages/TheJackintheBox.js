...
function TheJackintheBox(props){

    const origMovName = props.origMovName;
    const movName = "The Jack in the Box";
    const movVal = "Release Date: 2019\n\nRating: 8/10\n\nA British horror film that made its debut in 2019. Unique concept, but poor effects at some points. Rest of review coming soon!\n";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BN2Y1YzI2MzMtNmFmMS00YTU4LWFkYTUtNGUzZDU5YTE1NGQxXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default TheJackintheBox;