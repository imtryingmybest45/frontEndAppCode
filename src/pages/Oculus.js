...
function Oculus(props){
    ...
    const movVal = "Release Date: 2014\n\nRating: 8/10\n\nNot to be confused with the VR headset, Oculus is a gripping supernatural horror film that will keep you on the edge of your seat. Rest of review coming soon!";
    const movTier = "A";
