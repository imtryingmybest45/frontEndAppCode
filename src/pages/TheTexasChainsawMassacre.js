...
function TheTexasChainsawMassacre(props){
    ...
    const movVal = "Release Date: 1974\n\nRating: 7.5/10\n\nSurprisingly well-done and scary for a 70s movie.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNzY0MDQwMTctYzQ1Mi00ODIwLThlMWQtODQ0NzA2ZTg3ZDFhXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
