...
function TheLionKing2(props){

    const origMovName = props.origMovName;
    const movName = "The Lion King 2";
    const movVal = "Release Date: A Long Ass Time Ago\n\nRating: Not As Good As The Original\n\nI'm just putting this review on here to test my website.";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BY2Y3MTk2MDgtOTc1Yy00ZmFjLThlNTEtMDQ1Y2EzZmRjMzVjXkEyXkFqcGdeQXVyNjk1Njg5NTA@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
