...
function Hostel(props){
    ...
    const movVal = "Release Date: 2006\n\nRating: 7.5/10\n\nTruthfully, this movie deserves to be in B or even A tier. I don't know what I was thinking when I put it in C tier, because this movie is a really fucked up ride.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTY1NDA3ODM1OV5BMl5BanBnXkFtZTcwMDM5NzEzMQ@@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
