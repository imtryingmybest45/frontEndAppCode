...
function PhantomoftheOpera(props){

    const origMovName = props.origMovName;
    const movName = "Phantom of the Opera";
    const movVal = "this was a great movie, but its pretty old";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BZDVhZDM4NmItZWQ4OS00MDYxLWI5ZGItZDhmNTUyZGQwYWVmXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default PhantomoftheOpera;