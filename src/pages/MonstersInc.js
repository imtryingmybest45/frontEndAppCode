...
function MonstersInc(props){

    const origMovName = props.origMovName;
    const movName = "Monsters, Inc.";
    const movVal = "Great movie. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTY1NTI0ODUyOF5BMl5BanBnXkFtZTgwNTEyNjQ0MDE@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
