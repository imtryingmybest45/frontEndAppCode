...
function HowToTrainYourDragon(props){

    const origMovName = props.origMovName;
    const movName = "How To Train Your Dragon";
    const movVal = "This is not a horror movie.";
    const movTier = "F";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjA5NDQyMjc2NF5BMl5BanBnXkFtZTcwMjg5ODcyMw@@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default HowToTrainYourDragon;