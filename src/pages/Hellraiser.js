...
function Hellraiser(props){

    const origMovName = props.origMovName;
    const movName = "Hellraiser";
    const movVal = "Release Date: 1987\n\nRating: 6.5/10\n\nYet another poorly executed, cheesy 80s horror movie. :/";
    const movTier = "C";
    const movYear = "1987";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BZGI4MzkzNzQtYjA3MC00ZjE1LWI0NWUtMDdjNWQ3OTgxZTkwXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
