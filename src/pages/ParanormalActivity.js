...
function ParanormalActivity(props){

    const origMovName = props.origMovName;
    const movName = "Paranormal Activity";
    const movVal = "Release Date: 2007\n\nRating: 6.5/10\n\nOverhyped movie. Maybe I'm desensitized to supernatural films, I don't know. I don't think it deserves its notoriety.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjY1NjcxODQ4MV5BMl5BanBnXkFtZTcwMzUxNjM4Mg@@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
