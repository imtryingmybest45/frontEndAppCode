...
function Fridaythe13th(props){
    ...
    const movVal = "Release Date: 1980\n\nRating: 7.5/10";
    const movTier = "B";
    const movYear = "1980";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BZjEwOTY5MjMtMTkzMi00Zjk1LThkM2QtZGZhMzQ3MzI3NDNhXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
