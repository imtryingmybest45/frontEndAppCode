...
function Fridaythe13th(props){

    const origMovName = props.origMovName;
    const movName = "Friday the 13th";
    const movVal = "This is the review for Friday the 123th";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNzI1ODZhNDctNTdjOC00Mzg2LTg1ZjktNjJkNjA2YzYxMGQzXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
