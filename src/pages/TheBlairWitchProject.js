...
function TheBlairWitchProject(props){

    const origMovName = props.origMovName;
    const movName = "The Blair Witch Project";
    const movVal = "Release Date: 1999\n\nRating: 6/10\n\nAnother overhyped \"classic.\" This movie might as well be called \"Three Idiots Wander Around in the Forest.\" Some scary moments, but overall a snoozefest.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNGFmYzA5NzktOTc1Ni00YTIxLWJiZTEtNmEyZjBjNDM2MjRlXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default TheBlairWitchProject;