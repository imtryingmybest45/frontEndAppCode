...
function GonjiamHauntedAsylum(props){

    const origMovName = props.origMovName;
    const movName = "Gonjiam: Haunted Asylum";
    const movVal = "Release Date: 2018\n\nRating: 8.5/10\n\nThis movie was so fucking scary. I have no idea why I put it in B tier originally.";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BOWI1Yjk5ZWEtZjcyNS00NmZkLWFkNzUtMDA5YmNhODA1ZDVhXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default GonjiamHauntedAsylum;