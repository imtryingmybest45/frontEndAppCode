...
function Polaroid(props){
    ...
    const movName = "Polaroid";
    const movVal = "Release Date: 2019\n\nRating: Meh/10\n\nIt’s aight. Neat concept, but poorly executed at times. Not very memorable.";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTU2MDI0NDYxNl5BMl5BanBnXkFtZTgwMDAxOTQxMjI@._V1_SX300.jpg'} alt="This is the movie poster for this movie"/>}
