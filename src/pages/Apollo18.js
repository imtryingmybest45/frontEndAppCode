...
function Apollo18(props){

    const origMovName = props.origMovName;
    const movName = "Apollo 18";
    const movVal = "Release Date: 2011\n\nRating: 6/10\n\nAll I remember about this movie is that it had spiders. In space. Scary space spiders.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTk5MTk3OTk3OV5BMl5BanBnXkFtZTcwMzg4MzgxNg@@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
