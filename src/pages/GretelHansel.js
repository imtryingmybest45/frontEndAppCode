...
function GretelHansel(props){

    const origMovName = props.origMovName;
    const movName = "Gretel & Hansel";
    const movVal = "Release Date: 2020\n\nRating: 7/10\n\nA decent indie horror movie, wavering on whether or not it should be in B tier.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNGU1NTQwNzQtNDU1YS00YWVkLWJlZDYtODlhZjFkNjI3ODBiXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
