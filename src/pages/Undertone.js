...
function Undertone(props){

    const origMovName = props.origMovName;
    const movName = "Undertone";
    const movVal = "Release Date: 2026\n\nRating: 9.5/10\n\nThis movie did not have the right to be so insanely good. FINALLY, a modern movie that's made it into S tier!";
    const movTier = "S";
    const movYear = "2026";
