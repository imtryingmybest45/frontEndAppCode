...
function DragMeToHell(props){

    const origMovName = props.origMovName;
    const movName = "Drag Me To Hell";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTQwNTMyNjc5Ml5BMl5BanBnXkFtZTcwOTI2MTQ0Mg@@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
