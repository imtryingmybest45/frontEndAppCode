...
function Saw(props){
    ...
    const movName = "Saw";
    const movVal = "Hello! This movie doesn't exist, so I'm hoping that the only thing that will show up is an alt tag.";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BZTE5MzFlMTktMzBkOC00ZjMxLThmOTAtOGU3ZGEwZGRlNDdjXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie"/>}
