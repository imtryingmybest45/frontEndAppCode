...
function ItChapterTwo(props){

    const origMovName = props.origMovName;
    const movName = "It Chapter Two";
    const movVal = "Release Date: 2019\n\nRating: 6/10\n\nPlot dragged on way too long and had a ridiculous ending. Some scary parts, but nothing compared to the first one.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BYzUxM2VhOGItZTY2My00OTA4LWI4NjUtMDA5YWJjM2M2NDJjXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
