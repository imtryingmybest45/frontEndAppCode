...
function Terrifier2(props){
    ...
    const movVal = "Release Date: 2022\n\nRating: 9/10\n\nHonestly, I think I liked this one more than the first one. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BYTUyZWM1MDgtMGZiZi00OWZlLTgwNzItZGU3NTkwN2I4OWNiXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
