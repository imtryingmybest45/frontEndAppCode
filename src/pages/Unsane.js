...
function Unsane(props){

    const origMovName = props.origMovName;
    const movName = "Unsane";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNTYzMDYzMzA1MV5BMl5BanBnXkFtZTgwODUzODg2NDM@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
