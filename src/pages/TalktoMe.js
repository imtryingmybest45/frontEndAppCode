...
function TalktoMe(props){

    const origMovName = props.origMovName;
    const movName = "Talk to Me";
    const movVal = "Release Date: 2023\n\nRating: 6/10\n\nThis movie was okay. Neat concept, but not super scary. Rest of review coming soon!";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BY2I2NzJmY2YtYTM3Ni00ZGJhLThkZTItODFhMzhlZjZkMDQ5XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
