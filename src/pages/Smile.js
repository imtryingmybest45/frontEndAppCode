...
function Smile(props){
    ...
    const movName = "Smile";
    const movVal = "Release Date: 2022\n\nRating: 8/10\n\nI need to rewatch this...I don't remember why I put it in B tier. I remember it being a better movie.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNjFhMzBlNzktMjE2Ni00YTMyLWI2YWUtYmM1N2QxMDQwZmZhXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
