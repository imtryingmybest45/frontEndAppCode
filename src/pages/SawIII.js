...
function SawIII(props){

    const origMovName = props.origMovName;
    const movName = "Saw III";
    const movVal = "Release Date: 2006\n\nRating: 8.5/10\n\nVery, very memorable plot. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BODQ4YTAwZTItZGFjZi00YjNiLTllYzUtYWY3OWM2OTQzODVkXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
