...
function Longlegs(props){

    const origMovName = props.origMovName;
    const movName = "Longlegs";
    const movVal = "Release Date: 2024\n\nRating: 7/10\n\nFrankly, I thought this movie was overhyped.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMmJkNGNiNjgtMzFlYy00ZDI5LWI2YzktZGVjYjI5MjQyMGU3XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
