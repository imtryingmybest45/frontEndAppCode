...
function ScaryStoriestoTellintheDark(props){

    const origMovName = props.origMovName;
    const movName = "Scary Stories to Tell in the Dark";
    const movVal = "Release Date: 2019\n\nRating: 7.5/10\n\nSurprisingly freaky indie movie, was pleasantly surprised.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMDBiOTEwM2MtNTQ5NC00NGVhLWI1MTgtY2E3YmIzMTdlMjI3XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default ScaryStoriestoTellintheDark;