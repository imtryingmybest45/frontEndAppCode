...
function TheWickerMan2006(props){
    ...
    const movVal = "Release Date: 2006\n\nRating: 7/10\n\nA very cathartic movie for bitter single women.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BOTk5YWUxODAtZjc1NS00ZjNiLThlYmYtNDM3MWU2OGI3ZTljXkEyXkFqcGdeQXVyMTk2OTAzNTI@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
