...
function GetOut(props){
    ...
    const movName = "Get Out";
    const movVal = "Release Date: 2017\n\nRating: 8.5/10\n\nThis really should have been in A tier. I'll have to rewatch this one.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjUxMDQwNjcyNl5BMl5BanBnXkFtZTgwNzcwMzc0MTI@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
