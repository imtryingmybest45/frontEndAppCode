...
function Pearl(props){
    ...
    const movName = "Pearl";
    const movVal = "Release Date: 2022\n\nRating: 7/10\n\nThis movie was okay…I’m not really a fan of the Pearl trilogy, but they’re solid movies.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNzk0Y2RlZjItZDUzYi00Y2JhLTk5MzMtNjgzYWFmZmUxN2FmXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
