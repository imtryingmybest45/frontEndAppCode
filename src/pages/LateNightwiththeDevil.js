...
function LateNightwiththeDevil(props){

    const origMovName = props.origMovName;
    const movName = "Late Night with the Devil";
    const movVal = "Release Date: 2023\n\nRating: 6.5/10\n\nInteresting concept, but tacky ending. Would have been great if it weren’t for the over-the-top CGI effects.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BYTRiNWZlNGMtOTUwZi00ZjE4LWE1ZjEtNWE4MGQ2ZGU5NDliXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default LateNightwiththeDevil;