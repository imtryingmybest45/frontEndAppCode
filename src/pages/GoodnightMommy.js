...
function GoodnightMommy(props){

    const origMovName = props.origMovName;
    const movName = "Goodnight Mommy";
    const movVal = "Release Date: 2022\n\nRating: 6.5/10\n\nGood movie, but bumped it down half a point when I found out it was a remake :/";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMjAyMDU2NjU4OF5BMl5BanBnXkFtZTgwNDg5ODc0NjE@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
