...
function AClockworkOrange(props){

    const origMovName = props.origMovName;
    const movName = "A Clockwork Orange";
    const movVal = "Release Date: 1971\n\nRating: 5.5/10";
    const movTier = "C";
    const movYear = "1971";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTY3MjM1Mzc4N15BMl5BanBnXkFtZTgwODM0NzAxMDE@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError={handleError}/>}
...
export default AClockworkOrange;