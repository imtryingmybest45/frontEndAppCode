...
function ACureforWellness(props){

    const origMovName = props.origMovName;
    const movName = "A Cure for Wellness";
    const movVal = "Release Date: 2016\n\nRating: 8/10\n\nThis movie's concept was very unique, if not a bit stomach-curdling. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTg5Njg1MzIwNl5BMl5BanBnXkFtZTgwNDU1NjczMDI@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default ACureforWellness;