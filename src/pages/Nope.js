...
function Nope(props){
    ...
    const movName = "Nope";
    const movVal = "Release Date: 2022\n\nRating: 6.5/10\n\nOne of Peele’s first mediocre movies. Interesting concept, but plot fell short at several points. Difficult to swallow, especially after his smash hits Get Out and Us. Hopefully his next film will succeed this one in quality.";
    const movTier = "C";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BODRlNWRhZWUtMzdlZC00ZDIyLWFhZjMtYTcxNjI1ZDIwODhjXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
