...
function TheWailing(props){

    const origMovName = props.origMovName;
    const movName = "The Wailing";
    const movVal = "6/10, mid movie.";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BODkwMTgxNjA2NF5BMl5BanBnXkFtZTgwMDc0OTcwOTE@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
