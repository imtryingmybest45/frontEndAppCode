...
function Collinisapoorloser(props){

    const origMovName = props.origMovName;
    const movName = "Collin is a poor loser";
    const movVal = "Possibly the greatest movie of all time, this movie stars Collin, a random kid from Jupiter, FL. He invested his entire net worth of two dollars into dogecoin, which he promptly lost because nobody knows what that is anymore. Once his family found out he was completely broke, they kicked him out of his house and he roamed the streets for a while. Somebody tried to mug him, but when they realized how poor he was, they felt sorry for him and gave him a dollar. He then invested that dollar into NFTs and lost all his money again. At this point, he was so broke that he died. The end.";
    const movTier = "S";
...
export default Collinisapoorloser;