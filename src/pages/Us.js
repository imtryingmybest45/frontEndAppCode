...
function Us(props){
    ...
    const movName = "Us";
    const movVal = "Release Date: 2019\n\nRating: 8.5/10\n\nAnother mind-bending psychological thriller from Jordan Peele. Rest of review coming soon!";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMzhkMjFkN2YtODU2Ni00YWYwLWExN2MtOWNjZmQxM2U4YTM5XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
