...
function ANightmareonElmStreet(props){

    const origMovName = props.origMovName;
    const movName = "A Nightmare on Elm Street";
    const movVal = "Release Date: 1984\n\nRating: 8/10";
    const movTier = "A";
    const movYear = "1984";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BNTZmN2VlMWMtMTdlMi00NDBhLWIyODMtODEwMzM0ODMwMWYwXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie." onError = {handleError}/>}
...
export default ANightmareonElmStreet;