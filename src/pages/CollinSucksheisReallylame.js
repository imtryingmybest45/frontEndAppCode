...
function CollinSucksheisReallylame(props){

    const origMovName = props.origMovName;
    const movName = "Collin Sucks, he is Really lame";
    const movVal = "S tier movie, could watch 1000 times.";
    const movTier = "S";
...
export default CollinSucksheisReallylame;