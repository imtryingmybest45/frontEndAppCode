...
function ISawtheTVGlow(props){

    const origMovName = props.origMovName;
    const movName = "I Saw the TV Glow";
    const movVal = "Release Date: 2024\n\nRating: Garbage/10\n\nWhat more can I say? This movie sucked.\n\nActually, I can say more, but I need to gather my thoughts to properly convey how much this movie sucked. Review in progress.";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BZTA2MGM5M2ItNDBjYi00OWJhLTk1MTMtMGIzMDZlYzg1N2Q3XkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie"/>}
