...
function Mama(props){
    ...
    const movName = "Mama";
    const movVal = "Release Date: 2013\n\nRating: 7.5/10\n\nSolid Guillermo del Toro movie…normally I don’t like his style, but I liked this movie.";
    const movTier = "B";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BMTM5MjIwNDAwMl5BMl5BanBnXkFtZTcwNzQyOTY0OA@@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
