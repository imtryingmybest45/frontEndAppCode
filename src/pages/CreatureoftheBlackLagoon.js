...
function CreatureoftheBlackLagoon(props){

    const origMovName = props.origMovName;
    const movName = "Creature of the Black Lagoon";
    const movVal = "I have no idea what this movie poster looks like, but I'm curious.";
...
export default CreatureoftheBlackLagoon;