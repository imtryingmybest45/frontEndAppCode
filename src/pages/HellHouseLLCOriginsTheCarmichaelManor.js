...
function HellHouseLLCOriginsTheCarmichaelManor(props){

    const origMovName = props.origMovName;
    const movName = "Hell House LLC Origins: The Carmichael Manor";
    const movVal = "Release Date: 2023\n\nRating: 9/10\n\nI don't know why I didn't put this in S tier.";
    const movTier = "A";
    ...
    return(
        <div>
            ...
            {varVar && <img src={'https://m.media-amazon.com/images/M/MV5BOWNkZmZhYTItMWE3Mi00ODA3LWI3NTItZGM3NDZjMTQ1YjRmXkEyXkFqcGc@._V1_SX300.jpg'} alt="This is the movie poster for this movie."/>}
...
export default HellHouseLLCOriginsTheCarmichaelManor;